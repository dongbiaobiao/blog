          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-50 rounded-2xl p-8 shadow-sm sticky top-24 hover:shadow-md transition-all">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">董彪彪</h3>
                <p className="text-indigo-600">算法工程师</p>
              </div>

              <div className="space-y-4">
                {[
                  { icon: 'fa-envelope-o', title: '邮箱', content: 'dongbiaobiao77@163.com' },
                  { icon: 'fa-phone', title: '电话', content: '130-7354-1626' },
                  { icon: 'fa-map-marker', title: '地址', content: '陕西省西安市' }
                ].map((item, index) => (
