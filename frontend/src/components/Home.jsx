        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/2 text-center md:text-left animate-fade-in">
            ...
            >
              ...
              <a href="#github" className="px-6 py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-900 shadow-lg hover:shadow-gray-200/50 transition-all flex items-center gap-2 group">
